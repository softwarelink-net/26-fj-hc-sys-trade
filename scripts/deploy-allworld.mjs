...
/**
 * Upload dist/ to:
 *   1) R2 26-fj-hc-sys-trade-assets  (project bucket)
 *   2) R2 allworld-sites/26-fj-hc-sys-trade/  (shared Allworld host)
 */
...
const siteId = process.argv[2] || '26-fj-hc-sys-trade'
const projectBucket = '26-fj-hc-sys-trade-assets'
